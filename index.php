...
<table width="975" border="1" align="center" style="background-image:url('slide image/bkgrnd_greydots.png');">
  ...
  <tr>
	...
	{
	?>
	<h3 align="center">Encrypted Email Server..........</h3>
	<pre>
	
You can send Encrypted emails!

Privacy is a big concern for some of us! Encryption is the key so big brother is not Watching you!
...
<a href="index.php?chk=7">.</a></marquee>
	</td>
  </tr>
  <tr>
    <td height="47" colspan="2">
	<h2 align="center">Brought to you by The Untouchables</h2>	</td>
  </tr>
</table>
<?php //include('ads/header.php');?>
</body>
